...
// ÀÏ¹ÝÇü º¸µå¿¡¼­ È®ÀåIO º¸µå·Î ³Ñ¾î°¡¸é¼­ ¸±·¹ÀÌ IO°¡ Ãâ·Â¿¡¼­ ÀÔ·ÂÀ¸·Î ¹Ù³¢¾ú±â ¶§¹®¿¡ ....
#if   defined(NormalBoard_DoorSlow) 
	TRISC0	=	0x0;    // VOICE ÀÏ¹Ý º¸µå ÀÎ °æ¿ì, ¸±·¹ÀÌ Ãâ·ÂÀ¸·Î ¼³Á¤ 
#endif
...
void    TestVoicePlay(void)
{
    ...
    _VOICE_ACT = VOICE_OFF; // ë¦¬ì…‹ í•˜ì´ : RFID ì •ìƒ ë™ìž‘ 
    ...
    for (;1;)
    {
		...
		AddicoreRFID_Halt();  // ë™ìž‘ ì¤‘ì§€ ì‹œí‚¤ëŠ” ê±´ë° ë™ìž‘ ì•ˆí•˜ëŠ”ê±° ê°™ë‹¤. 
    }
